...
def jogar(palavra):
    ...
    while not adivinhou and n_tentativas > 0:
        ...
        #TENTATIVA POR PALAVRA COMPLETA
        ...
        #Finaliza o jogo (Adivinhou = True ou tentativas = 0)
    if adivinhou == True:
